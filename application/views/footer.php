	...
	<script src="<?php echo base_url();?>js/plugins/jquery.nav.js"></script>
	<script src="<?php echo base_url();?>js/plugins/owl-carousel/owl.carousel.js"></script>
	 <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyB--HbHjt4nwMW9MQR9W6BSw6hVTmlVPQw"></script>
